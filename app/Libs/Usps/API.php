...
abstract class API {
    ...
    protected function checkForUserId()
    {
        if (is_null($this->userId)) {
            ...
            throw new \Exception('USPS: A user ID is required. None found in env (USPS_USERID)');
    ...
    protected function makeRequest(string $responseType = null)
    {
        ...
        info('request-data',[$this->convertToXML()]);
        $client = new Client(['base_uri' => $this->apiUrl, 'verify' => false]);
